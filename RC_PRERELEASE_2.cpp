...
// same as it's corresponding class
	private:
		string org, orgs, orgl, orgj, orgn, orgyn, orgd, orgt, name, emtype, emtype1, ptype, ptype1, ptype2, ptype3, email1, phone2, phone3, phone4, webtype, givenname, additionalname, yominame, givennameyomi, additionalnameyomi, familynameyomi, shortname, nickname, namesuffix, nameprefix, maidenname, birthday, initials, sensitivity, priority, mileage, dirserver, occup, hobby, subject, notes, language, billing, family, phone, gender, email, address, website, group;
// same as it's corresponding class
	public:
		contact *next;
		contact(){
...
// a getter bla bla bla ...
		void getContact(){
			cout << "\n\nName: " << name << "Family Name: " << family << "Phone Number: " << phone << "Phone Type: " << ptype << "Given Name: " << givenname << "Additional Name: " << additionalname << "Yomi Name: " << yominame << "Additional Name Yomi: " << additionalnameyomi << "Given Name Yomi: " << givennameyomi << "Family Name Yomi: " << familynameyomi << "Name Prefix: " << nameprefix << "Name Suffix: " << namesuffix << "Maiden Name: " << maidenname << "Short Name: " << shortname << "Nickname: " << nickname << "Birthday: " << birthday << "Language: " << language << "Initials: " << initials << "Directory Server: " << dirserver << "Billing: " << billing << "Sensitivity: " << sensitivity << "Priority: " << priority << "Subject: " << subject << "Notes: " << notes << "Hobby: " << hobby << "Occupation: " << occup << "Mileage: " << mileage << "Phone 2 Type:" << ptype1 << "Phone 2 Number: " << phone2 << "Phone 3 Type:" << ptype2 << "Phone 3 Number: " << phone3 << "Phone 4 Type: " << ptype3 << "Phone 4 Number: " << phone4 << "Address: " << address << "Gender: " << gender << "Organization Department: " << orgd << "Organization: " << org << "Organization Yomi Name: " << orgyn << "Organization Name: " << orgn << "Organization Sympol: " << orgs << "Organization Job: " << orgj << "Organization Location: " << orgl << "Organization Type: " << orgt << "Email Type: " << emtype << "Email: " << email << "Email 2 Type: " << emtype1 << "Email 2: " << email1 << "Website Type: " << webtype << "Website: " << website << "Group Membership: " << group << endl;
		}
};
// same as it's corresponding class
class contactsList{
...
// same as it's corresponding class
		contactsList();
		contact* find(string);
		void add(string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string);
		void deleteContact(string);
		contact* findContact(string);
		void insertAfter(contact*, string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string);
		void showContacts();
};
// same as it's corresponding class
...
void contactsList::add(string name, string family, string phone, string orgn, string orgyn, string orgt, string orgj, string orgl, string orgs, string org, string orgd, string emtype, string emtype1, string ptype, string ptype1, string ptype2, string ptype3, string email1, string phone2, string phone3, string phone4, string webtype, string givenname, string additionalname, string yominame, string givennameyomi, string additionalnameyomi, string familynameyomi, string shortname, string nickname, string namesuffix, string nameprefix, string maidenname, string birthday, string initials, string sensitivity, string priority, string mileage, string dirserver, string occup, string hobby, string subject, string notes, string language, string billing, string gender, string email, string address, string website, string group){
	contact* new_contact = new contact(name, family, phone, org, orgs, orgl, orgj, orgn, orgyn, orgd, orgt, emtype, emtype1, ptype, ptype1, ptype2, ptype3, email1, phone2, phone3, phone4, webtype, givenname, additionalname, yominame, givennameyomi, additionalnameyomi, familynameyomi, shortname, nickname, namesuffix, nameprefix, maidenname, birthday, initials, sensitivity, priority, mileage, dirserver, occup, hobby, subject, notes, language, billing, gender, email, address, website, group);
